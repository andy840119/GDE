...
namespace GDE.Tests.Visual.TestCaseEditor
{
    public class TestCaseIDMigration : TestCase
    {
        ...
        {
            var screen = new IDMigrationScreen(new Editor(new Level()));
            ...
            var stepList = screen.StepList;

            AddLabel("Step creation");
            AddAssert("Check whether common step is null", () => screen.CommonIDMigrationStep.Value == null); // Also a dummy to not fuck the tests
            ...
            AddAssert("Check common selected values", () => screen.CommonIDMigrationStep.Value.HasValues(1, 5, 15, 19));
            AddStep("Create a new step", () => stepList.AddStep(new SourceTargetRange(1, 5, 15)));
            ...
            AddAssert("Check common selected values", () => screen.CommonIDMigrationStep.Value.HasValues(20, 30, 40, 50));
            ...
            AddAssert("Check common selected values", () => screen.CommonIDMigrationStep.Value.HasValues(-1, -1, -1, -1));
            ...
            AddAssert("Check common selected values", () => screen.CommonIDMigrationStep.Value == null);
            ...
            AddAssert("Check whether common step is null", () => screen.CommonIDMigrationStep.Value == null);
