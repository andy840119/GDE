...
namespace GDEdit.Utilities.Objects.GeometryDash.EditorHelper
{
    ...
    public class OutlineCreation
    {
        ...
        /// <summary>Initializes a new instance of the <seealso cref="OutlineCreation"/> class.</summary>
        /// <param name="originalObjectID">The original object ID.</param>
        /// <param name="createdObjectID">The created object ID.</param>
        public OutlineCreation(int originalObjectID, int createdObjectID)
        {
